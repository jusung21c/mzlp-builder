...
import TableBuildRunner from './runner-table'
import IndexBuildRunner from './runner-indexDB'
import DirSystem from './dir'
...
export default {
  ...
  LangClickListener(builder){
    ...
    $("#btn_lang_OK").click(function(){
      ...
      let lang = "KOK";
      let runner = new IndexBuildRunner(lang);
      console.log(runner.getCommandAll("KOK"));
