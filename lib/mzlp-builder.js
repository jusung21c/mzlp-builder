    ...
    for(let i in this.detaillist){
      ...
      $("#filename_"+i).change(function(){
        console.log($("#filename_"+i).val())
          this.detaillist[i].filename=$("#filename_"+i).val()
          console.log(this.detaillist[i].filename)
      })
    }
      ...
      for(let i in selectedlanglist){
        ...
        try {
            ...
            for(let i in afilefullpath){
                ...
                instancelist.push(this.getBuilder(builder,builderfullpath,file,selectedlanglist[i]));
            }
